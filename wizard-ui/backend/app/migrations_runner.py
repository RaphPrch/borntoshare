...
Runs the SQL pack located in: app/sql/
- 01_schema.sql
- 02_views.sql
- 03_indexes.sql
- 04_seed.sql
...
# SQL keywords that imply a REAL table usage
...
def _assert_sql_is_safe(sql: str, filename: str) -> None:
    ...
    Rules:
    - real tables are forbidden (FROM / JOIN / INSERT / UPDATE)
    ...
    for table in FORBIDDEN_TABLES:
        pattern = rf"\b{SQL_TABLE_CONTEXT}\s+{table}\b"
